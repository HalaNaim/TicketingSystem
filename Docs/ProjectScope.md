...
- **Employees** can log in and submit tickets.

- **IT agents** can view, assign, and resolve tickets.

- **Administrator** can manage users, roles, and categories.

- **System** sends notifications (email or in-app).
...
- Reliable relational database with backup support.

- Clear documentation and collaborative workflows using GitHub.
